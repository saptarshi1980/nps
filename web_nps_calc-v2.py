...
class NPSCalculator:
    ...
    def generate_pie_chart(self):
        ...
        ax.annotate(f"Monthly Pension: {format_amount(self.monthly_pension)}", 
    ...
    def export_to_pdf(self):
        ...
        items = {
            ...
            "Estimated Monthly Pension": f"{format_amount(self.monthly_pension)} ({self.monthly_pension_words})",
    ...
    if submitted:
        try:
            ...
            with tab1:
                ...
                with results_col2:
                    st.metric("Estimated Monthly Pension", format_metric_value(nps.monthly_pension))
